...
// function total(){
//    return orders.reduce((acc, curr) =>  [...acc, curr.price * (curr.tax + 1)] , [] )
// }

// function ordersTotal(){
//   return orders.map(orders => orders.price * (orders.tax + 1), )
// }

const orderTotals = orders.map((element, index, arr) =>{
